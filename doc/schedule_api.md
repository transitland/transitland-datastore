...
| departing_between      | Time,Time | Origin departure time between two times | [departing between 09:00 - 09:10](http://transit.land/api/v1/schedule_stop_pairs?departing_betweem=09:00:00,09:10:00) |
| trip                   | String | Trip identifier | [on trip '03SFO11SUN'](http://transit.land/api/v1/schedule_stop_pairs?trip=03SFO11SUN) |
| bbox                   | Lon1,Lat1,Lon2,Lat2 | Origin Stop within bounding box | [in the Bay Area](http://transit.land/api/v1/schedule_stop_pairs?bbox=-122.4,37.7,-122.4,30.8)
