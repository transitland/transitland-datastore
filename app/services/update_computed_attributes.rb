...
class UpdateComputedAttributes::GeometryUpdateComputedAttributes < UpdateComputedAttributes
  ...
  def update_rsps_and_ssps_stop_distances
    ...
    @rsps_to_update_distances.each { |rsp|
      ...
      begin
        stop_distances = Geometry::MetaDistances.new(rsp).calculate_distances
        ...
        rsp.update_making_history(changeset: @changeset, new_attrs: { stop_distances: Geometry::DistanceCalculation.new(rsp).fallback_distances })
      end
