...
class ScheduleStopPair < BaseScheduleStopPair
  ...
  def self.interpolate_linear(group)
    ...
    fail Exception.new("First stop in trip must have a departure time") unless window_start
    fail Exception.new("Last stop in trip must have an arrival time") unless window_end
